...
TEST(InlineAwaitTest, InlineAwaitTest_tasks_void_return)
{
    ...
    auto awaitable = tinycoro::AllOfAwait(task(), task(), task());
...
TEST(InlineAwaitTest, InlineAwaitTest_container_int_return)
{
    ...
    auto awaitable = tinycoro::AllOfAwait(container);
...
TEST(InlineAwaitTest, InlineAwaitTest_coawait)
{
    ...
    auto result = tinycoro::AllOf(wrapper());
...
TEST(InlineAwaitTest, InlineAwaitTest_coawait_exception)
{
    ...
    auto func = [&] { std::ignore = tinycoro::AllOf(wrapper()); };
...
TEST(InlineAwaitTest, InlineAwaitTest_coawait_container)
{
    ...
    auto wrapper = [&]() -> tinycoro::InlineTask<int32_t> {
        ...
        auto res = co_await tinycoro::AllOfAwait(vec);
...
TEST(InlineAwaitTest, InlineAwaitTest_coawait_container_void)
{
    ...
    auto wrapper = [&]() -> tinycoro::InlineTask<> {
        ...
        co_await tinycoro::AllOfAwait(vec);
        co_return;
    };

    tinycoro::AllOf(wrapper());
...
TEST(AnyOfAwaitTest, AnyOfAwaitTest_stop_source_container)
{
    ...
    auto awaiter = tinycoro::AnyOfAwait(ss, vec);
    EXPECT_TRUE(awaiter.await_ready());
    EXPECT_FALSE(awaiter.await_suspend(int32_t{}));
...
TEST(AnyOfAwaitTest, AnyOfAwaitTest_functional_test_stopSource)
{
...
TEST(AnyOfAwaitTest, AnyOfAwaitTest_functional_test_stopSource_vector)
{
    std::stop_source stopSource{};
...
TEST(AnyOfAwaitTest, AnyOfAwaitTest_functional_test_InlineNIC)
{
    std::stop_source stopSource{};
...
TEST(AnyOfAwaitTest, AnyOfAwaitTest_functional_test_InlineNIC_vector)
{
    std::stop_source stopSource{};
