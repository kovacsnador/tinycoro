...
{
    tinycoro::detail::PromiseT<FinalAwaiterMock, tinycoro::detail::PromiseReturnValue<int32_t, FinalAwaiterMock>, std::stop_source, tinycoro::DefaultAllocator> promise;
    EXPECT_TRUE(requires { promise.return_value(42); });
    EXPECT_TRUE(requires { typename decltype(promise)::value_type; });
